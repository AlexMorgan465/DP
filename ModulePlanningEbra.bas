...
Sub GenererPlanningAccessibilite()
    ...
    projectName = InputBox("Nom du projet / de l'activité r générer (ex: Ebra presse) :", _
                            "Génération du planning", "Ebra presse")
    If Trim(projectName) = "" Then Exit Sub

    weekStartStr = InputBox("Date du LUNDI de la semaine r générer (jj/mm/aaaa) :", _
    ...
    colActivite = GetCol(headers, "Activité")
    ...
    MsgBox "Planning généré avec succcs dans la feuille '" & wsPlan.Name & _
           "'." & vbCrLf & "La BDD a été mise r jour pour la semaine du " & _
...
'--------------------------------------------------------------------
' Detection du role Manager - ADAPTER ICI si votre critcre est different
...
Function NormalizeHeader(ByVal s As String) As String
    Dim r As String
    r = UCase(Trim(s))
    r = Replace(r, "É", "E"): r = Replace(r, "C", "E"): r = Replace(r, "E", "E"): r = Replace(r, "Ë", "E")
    r = Replace(r, "R", "A"): r = Replace(r, "Â", "A")
    r = Replace(r, "Ô", "O")
    r = Replace(r, "Î", "I"): r = Replace(r, "D", "I")
    r = Replace(r, "U", "U"): r = Replace(r, "U", "U")
    r = Replace(r, "Ç", "C")
    r = Replace(r, ".", "")
    r = Replace(r, "'", "")
    r = Replace(r, "-", "")
